...
public class Robot extends TimedRobot {
  ...
  static private int ENCODER_EPR = 1440;
  ...
  public void robotInit() {
    ...
    // create left motor
    Spark leftMotor = setupSpark(3, Sides.LEFT, false);

    ArrayList<SpeedController> leftMotors = new ArrayList<SpeedController>();
    leftMotors.add(setupSpark(2, Sides.FOLLOWER, false));
    ...
    rightMotors.add(setupSpark(0, Sides.FOLLOWER, false));
