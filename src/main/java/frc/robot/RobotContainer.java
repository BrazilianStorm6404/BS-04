...
public class RobotContainer {
  ...
  // CAN - por favor, realmente não vejo razão pra encostar nisso
  ...
  private NavX m_navx;
  private Pixy m_pixy;
  private Encoder_AMT103 encoderT1, encoderT2;
  ...
  private void configureButtonBindings() {
    ...
    ButtonA_1.whenPressed(() -> 
      ...
      new Turn(m_DriveTrain, 90, m_navx)
    );
  ...
  public void init() {
    ...
    //encoderT2 = new Encoder_AMT103(Constants.Sensors.ENC_T2_WHEEL_A.getPort(),Constants.Sensors.ENC_T2_WHEEL_B.getPort(),true);
    //encoderT2.setDistancePerPulse(Math.PI * 4 * 2.54/ 360.0);
    //encoderT2.setMinRate(1.0);
    //encoderT2.setSamplesToAverage(5);
